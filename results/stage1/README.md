...
produced by `configs/experiments_hpo_stage1.yaml --models <model>`.  They let Stage 2 be regenerated
...
Stage-2 configurations are generated, not committed: they depend on these results.
